...
<head>
    ...
    <title>Vibora Padel Store API Documentation</title>
...
<div class="tocify-wrapper">
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="introduction">
                    <a href="#introduction">Introduction</a>
                                    ...
                                    <ul id="tocify-subheader-introduction" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="recursos-disponibles">
                                <a href="#recursos-disponibles">Recursos disponibles</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="authenticating-requests">
                    ...
                    <ul id="tocify-header-catalogo" class="tocify-header">
                <li class="tocify-item level-1" data-unique="catalogo">
                    <a href="#catalogo">Catálogo</a>
                </li>
                                    <ul id="tocify-subheader-catalogo" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="catalogo-GETapi-products">
                                <a href="#catalogo-GETapi-products">Listar productos</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="catalogo-GETapi-products--slug-">
                                <a href="#catalogo-GETapi-products--slug-">Detalle de producto</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="catalogo-GETapi-categories">
                                <a href="#catalogo-GETapi-categories">Listar categorías</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="catalogo-GETapi-brands">
                                <a href="#catalogo-GETapi-brands">Listar marcas</a>
                            </li>
                                                                        </ul>
                            </ul>
                    <ul id="tocify-header-tienda" class="tocify-header">
                <li class="tocify-item level-1" data-unique="tienda">
                    <a href="#tienda">Tienda</a>
                </li>
                                    <ul id="tocify-subheader-tienda" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="tienda-POSTapi-orders">
                                <a href="#tienda-POSTapi-orders">Crear pedido</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="tienda-GETapi-orders">
                                <a href="#tienda-GETapi-orders">Listar pedidos</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="tienda-GETapi-orders--order_id-">
                                <a href="#tienda-GETapi-orders--order_id-">Mostrar pedido</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>Bienvenido a la documentación de la <strong>API de Vibora Padel Store</strong>.</p>
<p>Esta API permite que el sitio comercial se comunique con el backend de la tienda, ofreciendo acceso al catálogo de productos de pádel y la posibilidad de generar pedidos.</p>
<aside>Los endpoints de catálogo son públicos. La creación de pedidos no requiere autenticación: se realiza como invitado, registrando los datos de contacto y envío.</aside>
<h2 id="recursos-disponibles">Recursos disponibles</h2>
<ul>
<li><strong>Catálogo</strong>: listado y detalle de productos, categorías y marcas.</li>
<li><strong>Tienda</strong>: creación de pedidos con datos del cliente, dirección e items.</li>
</ul>
<p>Todas las respuestas se devuelven en formato JSON.</p>
...
<p>This API is not authenticated.</p>
    ...
    <p>Endpoints públicos para explorar el catálogo de la tienda.</p>

                                <h2 id="catalogo-GETapi-products">Listar productos</h2>

<p>
</p>

<p>Devuelve los productos activos con paginación. Permite filtrar por categoría, marca y búsqueda.</p>
...
<div class="bash-example">
    ...
    --get "http://localhost:8000/api/products?category=paletas&amp;brand=bullpadel&amp;search=pala" \
...
<i>optional</i> &nbsp;
 &nbsp;
    ...
    <br>
<p>Slug de la categoría. Example: <code>paletas</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="query">
    <br>
<p>Slug de la marca. Example: <code>bullpadel</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="query">
    <br>
<p>Búsqueda por nombre. Example: <code>pala</code></p>
            </div>
                </form>

                    <h2 id="catalogo-GETapi-products--slug-">Detalle de producto</h2>

<p>
</p>

<p>Devuelve un producto por su slug, con todas sus variantes y stock disponible.</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/products/pala-bullpadel-vertex" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/products/pala-bullpadel-vertex"
);
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               value="pala-bullpadel-vertex"
               data-component="url">
    <br>
<p>El slug del producto. Example: <code>pala-bullpadel-vertex</code></p>
            </div>
                    </form>

                    <h2 id="catalogo-GETapi-categories">Listar categorías</h2>

<p>
</p>

<p>Devuelve las categorías activas ordenadas por nombre.</p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="catalogo-GETapi-brands">Listar marcas</h2>

<p>
</p>

<p>Devuelve las marcas activas ordenadas por nombre.</p>
...
<p>Example: <code>application/json</code></p>
                ...
                <h1 id="tienda">Tienda</h1>
                                ...
                                <h2 id="tienda-POSTapi-orders">Crear pedido</h2>

<p>
</p>

<p>Crea un pedido desde la tienda con los datos del invitado, dirección e items.
Si el email ya existe, reutiliza la cuenta. El pedido nace en estado "pendiente".</p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="customer.name"                data-endpoint="POSTapi-orders"
               value="Juan Pérez"
               data-component="body">
    <br>
<p>Nombre del cliente. Example: <code>Juan Pérez</code></p>
                    </div>
                                                                <div style="margin-left: 14px; clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="customer.email"                data-endpoint="POSTapi-orders"
               value="juan@mail.com"
               data-component="body">
    <br>
<p>Email del cliente. Example: <code>juan@mail.com</code></p>
                    </div>
                                                                <div style="margin-left: 14px; clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="customer.phone"                data-endpoint="POSTapi-orders"
               value="2804555123"
               data-component="body">
    <br>
<p>Teléfono. Example: <code>2804555123</code></p>
                    </div>
                                                                <div style="margin-left: 14px; clear: unset;">
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               step="any"               name="customer.dni"                data-endpoint="POSTapi-orders"
               value="35123456"
               data-component="body">
    <br>
<p>DNI. Example: <code>35123456</code></p>
                    </div>
                                    </details>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               value="Av. Fontana 250"
               data-component="body">
    <br>
<p>Calle y número. Example: <code>Av. Fontana 250</code></p>
                    </div>
                                                                <div style="margin-left: 14px; clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Ciudad. Example: <code>Trelew</code></p>
                    </div>
                                                                <div style="margin-left: 14px; clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="address.province"                data-endpoint="POSTapi-orders"
               value="Chubut"
               data-component="body">
    <br>
<p>Provincia. Example: <code>Chubut</code></p>
                    </div>
                                                                <div style="margin-left: 14px; clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="address.postal_code"                data-endpoint="POSTapi-orders"
               value="9100"
               data-component="body">
    <br>
<p>Código postal. Example: <code>9100</code></p>
                    </div>
                                    </details>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>ID de la variante. Example: <code>1</code></p>
                    </div>
                                                                <div style="margin-left: 14px; clear: unset;">
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Cantidad. Example: <code>2</code></p>
                    </div>
                                    </details>
        </div>
        </form>

                    <h2 id="tienda-GETapi-orders">Listar pedidos</h2>

<p>
</p>

<p>Devuelve una lista paginada de los pedidos del cliente autenticado.</p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="tienda-GETapi-orders--order_id-">Mostrar pedido</h2>

<p>
</p>

<p>Devuelve los detalles de un pedido específico del cliente autenticado.</p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="url">
    <br>
<p>El ID del pedido. Example: <code>1</code></p>
            </div>
                    </form>
